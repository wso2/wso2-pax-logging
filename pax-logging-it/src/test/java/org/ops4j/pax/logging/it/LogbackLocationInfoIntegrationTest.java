...
public class LogbackLocationInfoIntegrationTest extends AbstractStdoutInterceptingIntegrationTestBase {
    ...
    public void locationInfo() {
        ...
        assertTrue(lines.contains("org.ops4j.pax.logging.it.LogbackLocationInfoIntegrationTest | locationInfo | LogbackLocationInfoIntegrationTest.java | 74 : [INFO] INFO using SLF4J"));
        assertTrue(lines.contains("org.ops4j.pax.logging.it.LogbackLocationInfoIntegrationTest | locationInfo | LogbackLocationInfoIntegrationTest.java | 76 : [INFO] INFO using Commons Logging"));
